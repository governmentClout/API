define({ "api": [
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "uuid",
            "description": "<p>the uuid of the executive</p>"
          }
        ]
      }
    },
    ...
    "version": "0.0.0",
    "filename": "components/adminexecutives.js",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "uuid",
            "description": "<p>UUID of the state</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "description": "<p>The endpoint returns all messages this user has received</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "version": "0.0.0",
    "filename": "components/receivemessages.js",
    "groupTitle": "Messages"
  },
  {
    "type": "get",
  ...
  },
  {
    ...
    "description": "<p>The endpoint allows you to reply message</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "sender",
            "description": "<p>uuid of the user sending the reply</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "receiver",
            "description": "<p>uuid of the user to receive the reply</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "message",
            "description": "<p>uuid of the message this reply is associated with</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "content",
            "description": "<p>content of the reply to be sent</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/states?sort=:sort&limi=:limit&page=:page",
    "title": "get States",
    "name": "getStates",
    "group": "States",
    "header": {
    ...
    "description": "<p>The endpoint returns all states</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
