...
const resets = require('./../components/resets');
const executives = require('./../components/executives');
const signatures = require('./../components/signatures');
const friendrequests = require('./../components/friendrequests');
const sendmessages = require('./../components/sendmessages');
const receivemessages = require('./../components/receivemessages');
const replymessages = require('./../components/replymessages');
const userexecutives = require('./../components/userexecutives');
const states = require('./../components/states');
const lga = require('./../components/lga');
const parties = require('./../components/parties');
const districts = require('./../components/districts');
const districtlga = require('./../components/districtlga');
