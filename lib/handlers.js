...
var uuid = randomString.generate({ length: 8, charset: 'alphabetic' }) + '-' + randomString.generate({ length: 4, charset: 'alphabetic' }) + '-' + randomString.generate({ length: 4, charset: 'alphabetic' }) + '-' + randomString.generate({ length: 4, charset: 'alphabetic' }) + '-' +randomString.generate({ length: 12, charset: 'alphabetic' })
