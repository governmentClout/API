							...
							if(!err && result.length > 0){
								...
								con.query(checkProfile, (err,result)=>{
									if(!err && 
										...
										let sql = "UPDATE profiles SET nationality='" + nationality + "', state ='"+state+"', lga ='"+lga+"', firstName='"+firstName+"', lastName='"+lastName+"', photo='"+phone+"','"+updated_at+"') WHERE uuid='" +uuid+ "'"; 
...
handlers._media.post = (data,callback)=>{
	//post a new media item
}

handlers._media.get = (data,callback)=>{
	//get a media
}

handlers._media.put = (data,callback)=>{
	//update a media
}

handlers._media.delete = (data,callback)=>{
	//delete a media
}
...
handlers._posts.post = (data,callback)=>{
	...
	callback(200,{'Success':'You have hit posts post endpoint'});
}

handlers._posts.get = (data,callback)=>{
	//create a new post
	callback(200,{'Success':'You have hit posts get endpoint'});
}
...
handlers._posts.delete = (data,callback)=>{
	//create a new post
	callback(200,{'Success':'You have hit posts delete endpoint'});
}
...
handlers.articles = (data,callback)=>{
	...
	if(acceptableMethods.indexOf(data.method) > -1){
		...
		handlers._articles[data.method](data,callback);
...
handlers._articles.post = (data,callback)=>{
	//create a new post
	callback(200,{'Success':'You have hit articles post endpoint'});
}

handlers._articles.get = (data,callback)=>{
	//create a new post
	callback(200,{'Success':'You have hit articles get endpoint'});
}

handlers._articles.put = (data,callback)=>{
	//create a new post
	callback(200,{'Success':'You have hit articles put endpoint'});
}

handlers._articles.delete = (data,callback)=>{
	//create a new post
	callback(200,{'Success':'You have hit articles delete endpoint'});
}
