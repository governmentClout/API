...
const migrations = (con)=>{
	...
	let queries = [
						...
						"CREATE TABLE IF NOT EXISTS " + config.db_name + ".posts ( id INT NOT NULL AUTO_INCREMENT , uuid VARCHAR(255) NOT NULL, user VARCHAR(255) NOT NULL , post TEXT NOT NULL ,  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , status INT(1) NULL DEFAULT NULL , location VARCHAR(255) NULL DEFAULT NULL , PRIMARY KEY (id)) ENGINE = InnoDB;",
