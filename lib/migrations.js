...
const migrations = (con)=>{
	...
	let queries = [
						...
						"CREATE TABLE IF NOT EXISTS "+ config.db_name +".districts ( id int NOT NULL AUTO_INCREMENT, name varchar(100) NOT NULL, code varchar(100) NOT NULL, PRIMARY KEY (id) ) ENGINE=InnoDB ; ",
