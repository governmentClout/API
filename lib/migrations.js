...
const migrations = (con)=>{
	...
	let queries = [
						...
						"CREATE TABLE " +config.db_name +".friends ( id INT NOT NULL AUTO_INCREMENT , uuid VARCHAR(255) NOT NULL, friend VARCHAR(255) NOT NULL , user VARCHAR(255) NOT NULL , created_at TIMESTAMP NOT NULL , updated_at TIMESTAMP NOT NULL , status INT(1) NOT NULL DEFAULT 0 , PRIMARY KEY (id)) ENGINE = InnoDB;"
