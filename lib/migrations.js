...
const migrations = (con)=>{
	...
	let queries = [
						...
						"ALTER TABLE gclout_db.posts ADD CONSTRAINT FOREIGN KEY (uuid) REFERENCES comments(ref) ON DELETE CASCADE;" ,
						"ALTER TABLE gclout_db.posts ADD CONSTRAINT FOREIGN KEY (uuid) REFERENCES views(post) ON DELETE CASCADE;",
						" ALTER TABLE gclout_db.posts ADD CONSTRAINT FOREIGN KEY (uuid) REFERENCES shares(post) ON DELETE CASCADE;",
						"ALTER TABLE gclout_db.posts ADD CONSTRAINT FOREIGN KEY (uuid) REFERENCES reactions(post) ON DELETE CASCADE;"
