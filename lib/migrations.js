...
const migrations = (con)=>{
	...
	let queries = [
						...
						"CREATE TABLE IF NOT EXISTS " + config.db_name + ".articles ( id INT NOT NULL AUTO_INCREMENT , uuid VARCHAR(255) NOT NULL, user VARCHAR(255) NOT NULL , post TEXT NOT NULL , title TEXT NOT NULL ,  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , status INT(1) NULL DEFAULT NULL , location VARCHAR(255) NULL DEFAULT NULL, attachment VARCHAR(255) NULL DEFAULT NULL, post_type VARCHAR(255) NULL DEFAULT 'post', PRIMARY KEY (id)) ENGINE = InnoDB;",
						...
						"CREATE TABLE IF NOT EXISTS " +config.db_name + ".friends ( id INT NOT NULL AUTO_INCREMENT , uuid VARCHAR(255) NOT NULL, friend VARCHAR(255) NOT NULL , user VARCHAR(255) NOT NULL , created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , updated_at TIMESTAMP NOT NULL , status INT(1) NOT NULL DEFAULT '0' , PRIMARY KEY (id)) ENGINE = InnoDB;",

						"CREATE TABLE IF NOT EXISTS " + config.db_name + ".polls ( id INT NOT NULL AUTO_INCREMENT , uuid VARCHAR(255) NOT NULL , sector VARCHAR(255) NOT NULL , opinion TEXT NOT NULL , created_by VARCHAR(255) NOT NULL , created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , updated_at TIMESTAMP NOT NULL , expire_at TIMESTAMP NULL , status INT(1) NOT NULL DEFAULT '0' , response_limit INT(255) NULL , PRIMARY KEY (id)) ENGINE = InnoDB",
					...
					//friends status: 0 - pending, 1 - ignored, 2 - accepted.
