...
const migrations = (con)=>{
	...
	let queries = [
						...
						"ALTER TABLE posts ADD CONSTRAINT DELETE_COMMENT_CAS FOREIGN KEY (uuid) REFERENCES comments(ref) ON DELETE CASCADE ON UPDATE NO ACTION; ALTER TABLE posts ADD CONSTRAINT DELETE_VIEWS_CAS FOREIGN KEY (uuid) REFERENCES views(post) ON DELETE CASCADE ON UPDATE NO ACTION; ALTER TABLE posts ADD CONSTRAINT DELETE_SHARES_CAS FOREIGN KEY (uuid) REFERENCES shares(post) ON DELETE CASCADE ON UPDATE NO ACTION; ALTER TABLE posts ADD CONSTRAINT DELETE_REACTION_CAS FOREIGN KEY (uuid) REFERENCES reactions(post) ON DELETE CASCADE ON UPDATE NO ACTION;",
