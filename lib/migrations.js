...
// 						"CREATE TABLE IF NOT EXISTS "  + config.db_name + ".profiles ( id INT(11) NOT NULL AUTO_INCREMENT , uuid VARCHAR(255) NOT NULL , nationality_origin VARCHAR(255) NOT NULL, nationality_residence VARCHAR(255) NOT NULL , state VARCHAR(255) NOT NULL , lga VARCHAR(255) NOT NULL , firstName VARCHAR(255) NOT NULL , lastName VARCHAR(255) NOT NULL , photo VARCHAR(255) NOT NULL , background VARCHAR(255) NOT NULL, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (id)) ENGINE = InnoDB;",
...
// 						"CREATE TABLE IF NOT EXISTS "+ config.db_name +".lga ( id int NOT NULL AUTO_INCREMENT, state_id int(11) NOT NULL, name varchar(100) NOT NULL, district_id int(11) NOT NULL, PRIMARY KEY (id) ) ENGINE=InnoDB ; ",
						
// 						"CREATE TABLE IF NOT EXISTS "+ config.db_name +".districts ( id int NOT NULL AUTO_INCREMENT, state_id int(11) NOT NULL,  name varchar(100) NOT NULL, code varchar(100) NOT NULL, PRIMARY KEY (id) ) ENGINE=InnoDB ; ",
						
// 						"CREATE TABLE IF NOT EXISTS "+ config.db_name +".fedreps ( id int NOT NULL AUTO_INCREMENT, name varchar(100) NOT NULL, district_id int(11) NOT NULL, PRIMARY KEY (id) ) ENGINE=InnoDB ; ",
						
// 						"CREATE TABLE IF NOT EXISTS "+ config.db_name +".parties ( id int NOT NULL AUTO_INCREMENT, name varchar(100) NOT NULL, motto TEXT NOT NULL, other_details TEXT NOT NULL, PRIMARY KEY (id) ) ENGINE=InnoDB ; ",
