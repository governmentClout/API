...
const migrations = (con)=>{
	...
	let queries = [
						...
						"CREATE TABLE IF NOT EXISTS "+ config.db_name +".lga ( id int NOT NULL AUTO_INCREMENT, state_id int(11) NOT NULL, name varchar(100) NOT NULL, PRIMARY KEY (id) ) ENGINE=InnoDB ; ",
